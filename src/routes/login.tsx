...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Login · Pressureboy808" }, { name: "description", content: "Login to your Pressureboy808 account." }] }),
  component: LoginPage,
});
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <Card className="w-full max-w-md p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to access your tips and dashboard.</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link to="/reset-password" className="text-xs text-primary-glow hover:underline">Forgot?</Link>
              </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            New here? <Link to="/signup" className="font-semibold text-primary-glow hover:underline">Create an account</Link>
          </p>
        </Card>
      </main>
      <Footer />
